    ...
    <div>
      ...
      <Routes>
        <Route path="" element={<Layout />}>
          ...
          <Route path="/league/games/:num" element={<LeagueGamePage />} />{" "}
          ...
          <Route path="/blast" element={<BlastHomePage />} />{" "}
          {/* Bullshit Blast Page */}
          <Route path="/blast/jeopardy" element={<BlastJeopardyPage />} />{" "}
          {/* Bullshit Blast Jeopardy Page */}
          <Route path="/blast/amongus" element={<BlastAmongusPage />} />{" "}
          {/* Bullshit Blast Among Us Page */}
