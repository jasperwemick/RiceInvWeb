...
// Game Profile page
// Objectives:
// 1) List tournaments of the game the player has participated in. 
// 2) On click, expand to show a list of chronological sets from the tournament the player was in
// 3) Show the player's rating for each gamemode
// 4) On set click go to Set Page when individual matches and player stats can be seen
// 
